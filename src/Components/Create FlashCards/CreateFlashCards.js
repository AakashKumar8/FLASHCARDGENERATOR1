        ...
        {({ values, handleChange, handleBlur, setFieldValue }) => (
          <Form>
                      ...
                      <div key={index} className='my-5 flex flex-wrap' >
                        ...
                        <div className='flex'>
                          ...
                          <div>
                            ...
                            <TbEdit className='text-[1.8em] text-black-700 m-2 cursor-pointer hover:text-black-900'
            ...
            <div className="h-28 flex  items-center justify-center">
              ...
              <button type='submit'
                className="bg-blue-600 hover:bg-blue-700 font-bold py-2 px-14 rounded text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 text-center ">
                Create
              </button>
            </div>
          </Form>
